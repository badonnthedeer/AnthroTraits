...
local function initAnthroTraits()
    ...
    local AT_Body = TraitFactory.addTrait("AT_Body", getText("UI_trait_AT_Body"), 1, getText("UI_trait_AT_Body_desc"), false);
    ...
    -- --TraitFactory.addTrait("AT_Diurnal", getText("UI_trait_AT_Diurnal"), 1, getText("UI_trait_AT_Diurnal_desc"), false);
    -- TraitFactory.addTrait("AT_Nocturnal", getText("UI_trait_AT_Nocturnal"), 1, getText("UI_trait_AT_Nocturnal_desc"), false);
    ...
    -- TraitFactory.addTrait("AT_KeenEyes", getText("UI_trait_AT_KeenEyes"), 1, getText("UI_trait_AT_KeenEyes_desc"), false);
    -- TraitFactory.addTrait("AT_KeenHearing", getText("UI_trait_AT_KeenHearing"), 1, getText("UI_trait_AT_KeenHearing_desc"), false);

    -- TraitFactory.addTrait("AT_BadEyes", getText("UI_trait_AT_BadEyes"), 1, getText("UI_trait_AT_BadEyes_desc"), false);
    -- TraitFactory.addTrait("AT_BadHearing", getText("UI_trait_AT_BadHearing"), 1, getText("UI_trait_AT_BadHearing_desc"), false);
    ...
    -- TraitFactory.addTrait("AT_ClippedWings", getText("UI_trait_AT_ClippedWings"), 1, getText("UI_trait_AT_ClippedWings_desc"), false);
