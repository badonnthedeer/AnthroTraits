...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	createDescInfo(AT_Carnivore, "AT_Carnivore",
		{ createDescVar("AT_CarnivoreBonus", 100), createDescVar("AT_CarnivoreMalus", 100) }
	)
	...
	createDescInfo(AT_CarrionEater, "AT_CarrionEater",
		{ createDescVar("AT_CarrionEaterBonus", 100) }
	)
	...
	createDescInfo(AT_Herbivore, "AT_Herbivore",
		{ createDescVar("AT_HerbivoreBonus", 100), createDescVar("AT_HerbivoreMalus", 100) }
	)
