# AnthroTraits
A mod for Project Zomboid that adds realistic, balanced traits for anthropomorphic player characters, and integrates with mods that provide furry player models. Updated for B42.13 (but not necessarily for mp).
...
<ul>
    ...
    Stomps do more damage and protect from scratches.<br>
    +1 Sprinting.<br>
    +1 Lightfoot.<br>
    +1 Sneak.
    </li>
    ...
    The damage and severity of your falls are reduced. Fall speed acceleration halved.
    </li>
    <li><h2>Tailed</h2>
